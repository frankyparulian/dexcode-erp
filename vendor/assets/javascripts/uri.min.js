...
(function(f,h){"object"===typeof exports?module.exports=h():"function"===typeof define&&define.amd?define(h):f.IPv6=h(f)})(this,function(f){var h=f&&f.IPv6;return{best:function(g){g=g.toLowerCase().split(":");var f=g.length,b=8;""===g[0]&&""===g[1]&&""===g[2]?(g.shift(),g.shift()):""===g[0]&&""===g[1]?g.shift():""===g[f-1]&&""===g[f-2]&&g.pop();f=g.length;-1!==g[f-1].indexOf(".")&&(b=7);var l;for(l=0;l<f&&""!==g[l];l++);if(l<b)for(g.splice(l,1,"0000");g.length<b;)g.splice(l,0,"0000");for(l=0;l<b;l++){for(var f=
  g[l].split(""),h=0;3>h;h++)if("0"===f[0]&&1<f.length)f.splice(0,1);else break;g[l]=f.join("")}var f=-1,q=h=0,m=-1,x=!1;for(l=0;l<b;l++)x?"0"===g[l]?q+=1:(x=!1,q>h&&(f=m,h=q)):"0"===g[l]&&(x=!0,m=l,q=1);q>h&&(f=m,h=q);1<h&&g.splice(f,h,"");f=g.length;b="";""===g[0]&&(b=":");for(l=0;l<f;l++){b+=g[l];if(l===f-1)break;b+=":"}""===g[f-1]&&(b+=":");return b},noConflict:function(){f.IPv6===this&&(f.IPv6=h);return this}}});
  (function(f){function h(b){throw RangeError(C[b]);}function g(b,e){for(var f=b.length;f--;)b[f]=e(b[f]);return b}function p(b,e){return g(b.split(y),e).join(".")}function b(b){for(var e=[],f=0,a=b.length,c,d;f<a;)c=b.charCodeAt(f++),55296<=c&&56319>=c&&f<a?(d=b.charCodeAt(f++),56320==(d&64512)?e.push(((c&1023)<<10)+(d&1023)+65536):(e.push(c),f--)):e.push(c);return e}function l(b){return g(b,function(b){var e="";65535<b&&(b-=65536,e+=z(b>>>10&1023|55296),b=56320|b&1023);return e+=z(b)}).join("")}function t(b,
    e){return b+22+75*(26>b)-((0!=e)<<5)}function q(b,e,f){var a=0;b=f?s(b/700):b>>1;for(b+=s(b/e);455<b;a+=36)b=s(b/35);return s(a+36*b/(b+38))}function m(b){var e=[],f=b.length,a,c=0,d=128,w=72,u,k,m,g,n;u=b.lastIndexOf("-");0>u&&(u=0);for(k=0;k<u;++k)128<=b.charCodeAt(k)&&h("not-basic"),e.push(b.charCodeAt(k));for(u=0<u?u+1:0;u<f;){k=c;a=1;for(m=36;;m+=36){u>=f&&h("invalid-input");g=b.charCodeAt(u++);g=10>g-48?g-22:26>g-65?g-65:26>g-97?g-97:36;(36<=g||g>s((2147483647-c)/a))&&h("overflow");c+=g*a;n=
    m<=w?1:m>=w+26?26:m-w;if(g<n)break;g=36-n;a>s(2147483647/g)&&h("overflow");a*=g}a=e.length+1;w=q(c-k,a,0==k);s(c/a)>2147483647-d&&h("overflow");d+=s(c/a);c%=a;e.splice(c++,0,d)}return l(e)}function x(e){var f,k,a,c,d,w,u,g,m,n=[],r,x,l;e=b(e);r=e.length;f=128;k=0;d=72;for(w=0;w<r;++w)m=e[w],128>m&&n.push(z(m));for((a=c=n.length)&&n.push("-");a<r;){u=2147483647;for(w=0;w<r;++w)m=e[w],m>=f&&m<u&&(u=m);x=a+1;u-f>s((2147483647-k)/x)&&h("overflow");k+=(u-f)*x;f=u;for(w=0;w<r;++w)if(m=e[w],m<f&&2147483647<
      ++k&&h("overflow"),m==f){g=k;for(u=36;;u+=36){m=u<=d?1:u>=d+26?26:u-d;if(g<m)break;l=g-m;g=36-m;n.push(z(t(m+l%g,0)));g=s(l/g)}n.push(z(t(g,0)));d=q(k,x,a==c);k=0;++a}++k;++f}return n.join("")}var A="object"==typeof exports&&exports,k="object"==typeof module&&module&&module.exports==A&&module,n="object"==typeof global&&global;if(n.global===n||n.window===n)f=n;var r,v=/^xn--/,e=/[^ -~]/,y=/\x2E|\u3002|\uFF0E|\uFF61/g,C={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)",
      "invalid-input":"Invalid input"},s=Math.floor,z=String.fromCharCode,B;r={version:"1.2.3",ucs2:{decode:b,encode:l},decode:m,encode:x,toASCII:function(b){return p(b,function(b){return e.test(b)?"xn--"+x(b):b})},toUnicode:function(b){return p(b,function(b){return v.test(b)?m(b.slice(4).toLowerCase()):b})}};if("function"==typeof define&&"object"==typeof define.amd&&define.amd)define(function(){return r});else if(A&&!A.nodeType)if(k)k.exports=r;else for(B in r)r.hasOwnProperty(B)&&(A[B]=r[B]);else f.punycode=
      r})(this);
      ...
      var h=f.lastIndexOf(".",b-1);if(0>=h||h>=b-1)return!1;var t=g.list[f.slice(b+1)];return t?0<=t.indexOf(" "+f.slice(h+1,b)+" "):!1},is:function(f){var b=f.lastIndexOf(".");if(0>=b||b>=f.length-1||0<=f.lastIndexOf(".",b-1))return!1;var h=g.list[f.slice(b+1)];return h?0<=h.indexOf(" "+f.slice(0,b)+" "):!1},get:function(f){var b=f.lastIndexOf(".");if(0>=b||b>=f.length-1)return null;var h=f.lastIndexOf(".",b-1);if(0>=h||h>=b-1)return null;var t=g.list[f.slice(b+1)];return!t||0>t.indexOf(" "+f.slice(h+
        ...
        "\\$1")}function t(a){return void 0===a?"Undefined":String(Object.prototype.toString.call(a)).slice(8,-1)}function q(a){return"Array"===t(a)}function m(a,c){var d,b;if(q(c)){d=0;for(b=c.length;d<b;d++)if(!m(a,c[d]))return!1;return!0}var e=t(c);d=0;for(b=a.length;d<b;d++)if("RegExp"===e){if("string"===typeof a[d]&&a[d].match(c))return!0}else if(a[d]===c)return!0;return!1}function x(a,c){if(!q(a)||!q(c)||a.length!==c.length)return!1;a.sort();c.sort();for(var d=0,b=a.length;d<b;d++)if(a[d]!==c[d])return!1;
          ...
          /[^a-zA-Z0-9\.-]/;b.domAttributes={a:"href",blockquote:"cite",link:"href",base:"href",script:"src",form:"action",img:"src",area:"href",iframe:"src",embed:"src",source:"src",track:"src",input:"src",audio:"src",video:"src"};b.getDomAttribute=function(a){if(a&&a.nodeName){var c=a.nodeName.toLowerCase();return"input"===c&&"image"!==a.type?void 0:b.domAttributes[c]}};b.encode=k;b.decode=decodeURIComponent;b.iso8859=function(){b.encode=escape;b.decode=unescape};b.unicode=function(){b.encode=k;b.decode=
            ...
            return a.join("/")};var C={encode:"encode",decode:"decode"},s,z=function(a,c){return function(d){try{return b[c](d+"").replace(b.characters[a][c].expression,function(d){return b.characters[a][c].map[d]})}catch(w){return d}}};for(s in C)b[s+"PathSegment"]=z("pathname",C[s]);b.encodeReserved=z("reserved","encode");b.parse=function(a,c){var d;c||(c={});d=a.indexOf("#");-1<d&&(c.fragment=a.substring(d+1)||null,a=a.substring(0,d));d=a.indexOf("?");-1<d&&(c.query=a.substring(d+1)||null,a=a.substring(0,
                ...
                c.username=d[0]?b.decode(d[0]):null,d.shift(),c.password=d[0]?b.decode(d.join(":")):null,a=a.substring(e+1)):(c.username=null,c.password=null);return a};b.parseQuery=function(a,c){if(!a)return{};a=a.replace(/&+/g,"&").replace(/^\?*&*|&+$/g,"");if(!a)return{};for(var d={},e=a.split("&"),f=e.length,k,g,m=0;m<f;m++)k=e[m].split("="),g=b.decodeQuery(k.shift(),c),k=k.length?b.decodeQuery(k.join("="),c):null,y.call(d,g)?("string"===typeof d[g]&&(d[g]=[d[g]]),d[g].push(k)):d[g]=k;return d};b.build=function(a){var c=
                  ...
                  b.buildQueryParameter=function(a,c,d){return b.encodeQuery(a,d)+(null!==c?"="+b.encodeQuery(c,d):"")};b.addQuery=function(a,c,d){if("object"===typeof c)for(var e in c)y.call(c,e)&&b.addQuery(a,e,c[e]);else if("string"===typeof c)void 0===a[c]?a[c]=d:("string"===typeof a[c]&&(a[c]=[a[c]]),q(d)||(d=[d]),a[c]=(a[c]||[]).concat(d));else throw new TypeError("URI.addQuery() accepts an object, string as the name parameter");};b.removeQuery=function(a,c,d){var e;if(q(c))for(d=0,e=c.length;d<e;d++)a[c[d]]=
                    void 0;else if("object"===typeof c)for(e in c)y.call(c,e)&&b.removeQuery(a,e,c[e]);else if("string"===typeof c)if(void 0!==d)if(a[c]===d)a[c]=void 0;else{if(q(a[c])){e=a[c];var f={},k,g;if(q(d))for(k=0,g=d.length;k<g;k++)f[d[k]]=!0;else f[d]=!0;k=0;for(g=e.length;k<g;k++)void 0!==f[e[k]]&&(e.splice(k,1),g--,k--);a[c]=e}}else a[c]=void 0;else throw new TypeError("URI.addQuery() accepts an object, string as the first parameter");};b.hasQuery=function(a,c,d,e){if("object"===typeof c){for(var f in c)if(y.call(c,
                      ...
                      a+'" contains characters other than [A-Z0-9.-]');}};b.noConflict=function(a){if(a)return a={URI:this.noConflict()},p.URITemplate&&"function"===typeof p.URITemplate.noConflict&&(a.URITemplate=p.URITemplate.noConflict()),p.IPv6&&"function"===typeof p.IPv6.noConflict&&(a.IPv6=p.IPv6.noConflict()),p.SecondLevelDomains&&"function"===typeof p.SecondLevelDomains.noConflict&&(a.SecondLevelDomains=p.SecondLevelDomains.noConflict()),a;p.URI===this&&(p.URI=v);return this};e.build=function(a){if(!0===a)this._deferred_build=
                        !0;else if(void 0===a||this._deferred_build)this._string=b.build(this._parts),this._deferred_build=!1;return this};e.clone=function(){return new b(this)};e.valueOf=e.toString=function(){return this.build(!1)._string};e.protocol=n("protocol");e.username=n("username");e.password=n("password");e.hostname=n("hostname");e.port=n("port");e.query=r("query","?");e.fragment=r("fragment","#");e.search=function(a,c){var d=this.query(a,c);return"string"===typeof d&&d.length?"?"+d:d};e.hash=function(a,c){var d=
                          ...
                          "",f=!1);!e&&f&&void 0!==a.pathname&&(a=a.toString());if("string"===typeof a||a instanceof String)this._parts=b.parse(String(a),this._parts);else if(e||f)for(d in e=e?a._parts:a,e)y.call(this._parts,d)&&(this._parts[d]=e[d]);else throw new TypeError("invalid input");this.build(!c);return this};e.is=function(a){var c=!1,d=!1,e=!1,f=!1,k=!1,m=!1,n=!1,h=!this._parts.urn;this._parts.hostname&&(h=!1,d=b.ip4_expression.test(this._parts.hostname),e=b.ip6_expression.test(this._parts.hostname),c=d||e,k=(f=
                            ...
                            var B=e.protocol,D=e.port,E=e.hostname;e.protocol=function(a,c){if(void 0!==a&&a&&(a=a.replace(/:(\/\/)?$/,""),!a.match(b.protocol_expression)))throw new TypeError('Protocol "'+a+"\" contains characters other than [A-Z0-9.+-] or doesn't start with [A-Z]");return B.call(this,a,c)};e.scheme=e.protocol;e.port=function(a,c){if(this._parts.urn)return void 0===a?"":this;if(void 0!==a&&(0===a&&(a=null),a&&(a+="",":"===a.charAt(0)&&(a=a.substring(1)),a.match(/[^0-9]/))))throw new TypeError('Port "'+a+'" contains characters other than [0-9]');
                                ...
                                !this._parts.hostname||this.is("IP")?this._parts.hostname=a:(d=new RegExp(l(this.domain())+"$"),this._parts.hostname=this._parts.hostname.replace(d,a));this.build(!c);return this};e.tld=function(a,c){if(this._parts.urn)return void 0===a?"":this;"boolean"===typeof a&&(c=a,a=void 0);if(void 0===a){if(!this._parts.hostname||this.is("IP"))return"";var d=this._parts.hostname.lastIndexOf("."),d=this._parts.hostname.substring(d+1);return!0!==c&&g&&g.list[d.toLowerCase()]?g.get(this._parts.hostname)||d:d}if(a)if(a.match(/[^a-zA-Z0-9-]/))if(g&&
                                  g.is(a))d=new RegExp(l(this.tld())+"$"),this._parts.hostname=this._parts.hostname.replace(d,a);else throw new TypeError('TLD "'+a+'" contains characters other than [A-Z0-9]');else{if(!this._parts.hostname||this.is("IP"))throw new ReferenceError("cannot set TLD on non-domain host");d=new RegExp(l(this.tld())+"$");this._parts.hostname=this._parts.hostname.replace(d,a)}else throw new TypeError("cannot set TLD empty");this.build(!c);return this};e.directory=function(a,c){if(this._parts.urn)return void 0===
                                    ...
                                    this._parts.path=this._parts.path.replace(e,a));this.build(!c);return this};e.segment=function(a,c,d){var b=this._parts.urn?":":"/",e=this.path(),f="/"===e.substring(0,1),e=e.split(b);void 0!==a&&"number"!==typeof a&&(d=c,c=a,a=void 0);if(void 0!==a&&"number"!==typeof a)throw Error('Bad segment "'+a+'", must be 0-based integer');f&&e.shift();0>a&&(a=Math.max(e.length+a,0));if(void 0===c)return void 0===a?e:e[a];if(null===a||void 0===e[a])if(q(c)){e=[];a=0;for(var k=c.length;a<k;a++)if(c[a].length||
                                      ...
                                      else c="string"===typeof c||c instanceof String?b.encode(c):c;return this.segment(a,c,d)};var F=e.query;e.query=function(a,c){if(!0===a)return b.parseQuery(this._parts.query,this._parts.escapeQuerySpace);if("function"===typeof a){var d=b.parseQuery(this._parts.query,this._parts.escapeQuerySpace),e=a.call(this,d);this._parts.query=b.buildQuery(e||d,this._parts.duplicateQueryParameters,this._parts.escapeQuerySpace);this.build(!c);return this}return void 0!==a&&"string"!==typeof a?(this._parts.query=
                                        b.buildQuery(a,this._parts.duplicateQueryParameters,this._parts.escapeQuerySpace),this.build(!c),this):F.call(this,a,c)};e.setQuery=function(a,c,d){var e=b.parseQuery(this._parts.query,this._parts.escapeQuerySpace);if("string"===typeof a||a instanceof String)e[a]=void 0!==c?c:null;else if("object"===typeof a)for(var f in a)y.call(a,f)&&(e[f]=a[f]);else throw new TypeError("URI.addQuery() accepts an object, string as the name parameter");this._parts.query=b.buildQuery(e,this._parts.duplicateQueryParameters,
                                            ...
                                            -1===k&&(k=f);d=d.substring(0,k)+d.substring(f+3)}c&&this.is("relative")&&(d=e+d.substring(1));d=b.recodePath(d);this._parts.path=d;this.build(!a);return this};e.normalizePathname=e.normalizePath;e.normalizeQuery=function(a){"string"===typeof this._parts.query&&(this._parts.query.length?this.query(b.parseQuery(this._parts.query,this._parts.escapeQuerySpace)):this._parts.query=null,this.build(!a));return this};e.normalizeFragment=function(a){this._parts.fragment||(this._parts.fragment=null,this.build(!a));
                                              ...
                                              b.decodeQuery(a.hash(),!0)};e.absoluteTo=function(a){var c=this.clone(),d=["protocol","username","password","hostname","port"],e,f;if(this._parts.urn)throw Error("URNs do not have any generally defined hierarchical components");a instanceof b||(a=new b(a));c._parts.protocol||(c._parts.protocol=a._parts.protocol);if(this._parts.hostname)return c;for(e=0;f=d[e];e++)c._parts[f]=a._parts[f];c._parts.path?".."===c._parts.path.substring(-2)&&(c._parts.path+="/"):(c._parts.path=a._parts.path,c._parts.query||
                                                ...
                                                d.protocol===e.protocol&&(d.protocol=null);if(d.username===e.username&&d.password===e.password&&null===d.protocol&&null===d.username&&null===d.password&&d.hostname===e.hostname&&d.port===e.port)d.hostname=null,d.port=null;else return c.build();if(f===k)return d.path="",c.build();a=b.commonPath(c.path(),a.path());if(!a)return c.build();e=e.path.substring(a.length).replace(/[^\/]*$/,"").replace(/.*?\//g,"../");d.path=e+d.path.substring(a.length);return c.build()};e.equals=function(a){var c=this.clone();
                                                  a=new b(a);var d={},e={},f={},k;c.normalize();a.normalize();if(c.toString()===a.toString())return!0;d=c.query();e=a.query();c.query("");a.query("");if(c.toString()!==a.toString()||d.length!==e.length)return!1;d=b.parseQuery(d,this._parts.escapeQuerySpace);e=b.parseQuery(e,this._parts.escapeQuerySpace);for(k in d)if(y.call(d,k)){if(!q(d[k])){if(d[k]!==e[k])return!1}else if(!x(d[k],e[k]))return!1;f[k]=!0}for(k in e)if(y.call(e,k)&&!f[k])return!1;return!0};e.duplicateQueryParameters=function(a){this._parts.duplicateQueryParameters=
                                                    !!a;return this};e.escapeQuerySpace=function(a){this._parts.escapeQuerySpace=!!a;return this};return b});
                                                    (function(f,h){"object"===typeof exports?module.exports=h(require("./URI")):"function"===typeof define&&define.amd?define(["./URI"],h):f.URITemplate=h(f.URI,f)})(this,function(f,h){function g(b){if(g._cache[b])return g._cache[b];if(!(this instanceof g))return new g(b);this.expression=b;g._cache[b]=this;return this}function p(b){this.data=b;this.cache={}}var b=h&&h.URITemplate,l=Object.prototype.hasOwnProperty,t=g.prototype,q={"":{prefix:"",separator:",",named:!1,empty_name_separator:!1,encode:"encode"},
                                                    "+":{prefix:"",separator:",",named:!1,empty_name_separator:!1,encode:"encodeReserved"},"#":{prefix:"#",separator:",",named:!1,empty_name_separator:!1,encode:"encodeReserved"},".":{prefix:".",separator:".",named:!1,empty_name_separator:!1,encode:"encode"},"/":{prefix:"/",separator:"/",named:!1,empty_name_separator:!1,encode:"encode"},";":{prefix:";",separator:";",named:!0,empty_name_separator:!1,encode:"encode"},"?":{prefix:"?",separator:"&",named:!0,empty_name_separator:!0,encode:"encode"},"&":{prefix:"&",
                                                    separator:"&",named:!0,empty_name_separator:!0,encode:"encode"}};g._cache={};g.EXPRESSION_PATTERN=/\{([^a-zA-Z0-9%_]?)([^\}]+)(\}|$)/g;g.VARIABLE_PATTERN=/^([^*:]+)((\*)|:(\d+))?$/;g.VARIABLE_NAME_PATTERN=/[^a-zA-Z0-9%_]/;g.expand=function(b,f){var h=q[b.operator],k=h.named?"Named":"Unnamed",n=b.variables,r=[],v,e,l;for(l=0;e=n[l];l++)v=f.get(e.name),v.val.length?r.push(g["expand"+k](v,h,e.explode,e.explode&&h.separator||",",e.maxlength,e.name)):v.type&&r.push("");return r.length?h.prefix+r.join(h.separator):
                                                    ""};g.expandNamed=function(b,g,h,k,n,r){var v="",e=g.encode;g=g.empty_name_separator;var l=!b[e].length,q=2===b.type?"":f[e](r),s,p,t;p=0;for(t=b.val.length;p<t;p++)n?(s=f[e](b.val[p][1].substring(0,n)),2===b.type&&(q=f[e](b.val[p][0].substring(0,n)))):l?(s=f[e](b.val[p][1]),2===b.type?(q=f[e](b.val[p][0]),b[e].push([q,s])):b[e].push([void 0,s])):(s=b[e][p][1],2===b.type&&(q=b[e][p][0])),v&&(v+=k),h?v+=q+(g||s?"=":"")+s:(p||(v+=f[e](r)+(g||s?"=":"")),2===b.type&&(v+=q+","),v+=s);return v};g.expandUnnamed=
                                                    function(b,g,h,k,n){var r="",l=g.encode;g=g.empty_name_separator;var e=!b[l].length,q,p,s,t;s=0;for(t=b.val.length;s<t;s++)n?p=f[l](b.val[s][1].substring(0,n)):e?(p=f[l](b.val[s][1]),b[l].push([2===b.type?f[l](b.val[s][0]):void 0,p])):p=b[l][s][1],r&&(r+=k),2===b.type&&(q=n?f[l](b.val[s][0].substring(0,n)):b[l][s][0],r+=q,r=h?r+(g||p?"=":""):r+","),r+=p;return r};g.noConflict=function(){h.URITemplate===g&&(h.URITemplate=b);return g};t.expand=function(b){var f="";this.parts&&this.parts.length||this.parse();
                                                    ...
                                                    e[0]+'"');l=e[2].split(",");for(var t=0,s=l.length;t<s;t++){p=l[t].match(h);if(null===p)throw Error('Invalid Variable "'+l[t]+'" in "'+e[0]+'"');if(p[1].match(k))throw Error('Invalid Variable Name "'+p[1]+'" in "'+e[0]+'"');l[t]={name:p[1],explode:!!p[3],maxlength:p[4]&&parseInt(p[4],10)}}if(!l.length)throw Error('Expression Missing Variable(s) "'+e[0]+'"');n.push({expression:e[0],operator:e[1],variables:l})}n.length||n.push(b);this.parts=n;return this};p.prototype.get=function(b){var f=this.data,
                                                      g={type:0,val:[],encode:[],encodeReserved:[]},k;if(void 0!==this.cache[b])return this.cache[b];this.cache[b]=g;f="[object Function]"===String(Object.prototype.toString.call(f))?f(b):"[object Function]"===String(Object.prototype.toString.call(f[b]))?f[b](b):f[b];if(void 0!==f&&null!==f)if("[object Array]"===String(Object.prototype.toString.call(f))){k=0;for(b=f.length;k<b;k++)void 0!==f[k]&&null!==f[k]&&g.val.push([void 0,String(f[k])]);g.val.length&&(g.type=3)}else if("[object Object]"===String(Object.prototype.toString.call(f))){for(k in f)l.call(f,
                                                        ...
                                                        (function(f,h){"object"===typeof exports?module.exports=h(require("jquery","./URI")):"function"===typeof define&&define.amd?define(["jquery","./URI"],h):h(f.jQuery,f.URI)})(this,function(f,h){function g(b){return b.replace(/([.*+?^=!:${}()|[\]\/\\])/g,"\\$1")}function p(b){var f=b.nodeName.toLowerCase();return"input"===f&&"image"!==b.type?void 0:h.domAttributes[f]}function b(b){return{get:function(g){return f(g).uri()[b]()},set:function(g,h){f(g).uri()[b](h);return h}}}function l(b,g){var h,l,e;if(!p(b)||
                                                          !g)return!1;h=g.match(A);if(!h||!h[5]&&":"!==h[2]&&!q[h[2]])return!1;e=f(b).uri();if(h[5])return e.is(h[5]);if(":"===h[2])return l=h[1].toLowerCase()+":",q[l]?q[l](e,h[4]):!1;l=h[1].toLowerCase();return t[l]?q[h[2]](e[l](),h[4],l):!1}var t={},q={"=":function(b,f){return b===f},"^=":function(b,f){return!!(b+"").match(new RegExp("^"+g(f),"i"))},"$=":function(b,f){return!!(b+"").match(new RegExp(g(f)+"$","i"))},"*=":function(b,f,h){"directory"===h&&(b+="/");return!!(b+"").match(new RegExp(g(f),"i"))},
                                                          "equals:":function(b,f){return b.equals(f)},"is:":function(b,f){return b.is(f)}};f.each("authority directory domain filename fragment hash host hostname href password path pathname port protocol query resource scheme search subdomain suffix tld username".split(" "),function(g,h){t[h]=!0;f.attrHooks["uri:"+h]=b(h)});var m=function(b,g){return f(b).uri().href(g).toString()};f.each(["src","href","action","uri","cite"],function(b,g){f.attrHooks[g]={set:m}});f.attrHooks.uri.get=function(b){return f(b).uri()};
                                                          f.fn.uri=function(b){var f=this.first(),g=f.get(0),l=p(g);if(!l)throw Error('Element "'+g.nodeName+'" does not have either property: href, src, action, cite');if(void 0!==b){var e=f.data("uri");if(e)return e.href(b);b instanceof h||(b=h(b||""))}else{if(b=f.data("uri"))return b;b=h(f.attr(l)||"")}b._dom_element=g;b._dom_attribute=l;b.normalize();f.data("uri",b);return b};h.prototype.build=function(b){if(this._dom_element)this._string=h.build(this._parts),this._deferred_build=!1,this._dom_element.setAttribute(this._dom_attribute,
                                                            this._string),this._dom_element[this._dom_attribute]=this._string;else if(!0===b)this._deferred_build=!0;else if(void 0===b||this._deferred_build)this._string=h.build(this._parts),this._deferred_build=!1;return this};var x,A=/^([a-zA-Z]+)\s*([\^\$*]?=|:)\s*(['"]?)(.+)\3|^\s*([a-zA-Z0-9]+)\s*$/;x=f.expr.createPseudo?f.expr.createPseudo(function(b){return function(f){return l(f,b)}}):function(b,f,g){return l(b,g[3])};f.expr[":"].uri=x;return f});
